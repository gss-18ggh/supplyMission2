...
function setup() {
	...
	side1 = createSprite(400, height-30, 200, 10, {isStatic:true});
	side1.shapeColor="red"
	
	side2 = createSprite(300, height-55, 10, 70, {isStatic:true});
	side2.shapeColor="red"
	
	side3 = createSprite(500, height-55, 10, 70, {isStatic:true});
